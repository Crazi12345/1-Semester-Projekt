...
public class Level {
    ...
    public Room createRooms() {
        ...
        NPC Steve = new NPC("steve", Fish, "steve.png", "I miss my football", "Thank you for finding my football, i really want it back", Football);
        ...
        NPC Farmer = new NPC("farmer", Flour, "farmer.png", "I lost my scarecrow, i think the birds hid it from me ", "Will you please give me the scarecrow?", Scarecrow);
        NPC Teacher = new NPC("teacher", Apple, "teacher.png", "I have been looking for chalk all day", "That chalk is just what im looking for, can i have it?", Chalk);
        NPC Shopper = new NPC("shopper", Chalk, "shopper.png", "I have way too much chalk, give me a poster and i will give you some", "What an amazing poster, i must have it!", Poster);
        NPC Baker = new NPC("baker", Bread, "baker.png", "I just dropped my last bag of flour, can you get me some more", "Can i trade it for some bread?", Flour);
        NPC Abena = new NPC("abena", Rice, "abena.png", "i lost my dog, have you seen it", "Thank you, i was soo hungry, please give it back?", Dog);
        npcs_VC.add(Steve);
